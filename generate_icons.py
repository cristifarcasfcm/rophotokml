...
def create_icon(size, filename):
    ...
    # Rounded rectangle background (deep forest green / charcoal gradient feel)
    ...
    # Inner KML Polygon (emerald green translucent shape)
    poly_points = [
        (size * 0.15, size * 0.35),
        (size * 0.40, size * 0.15),
        (size * 0.85, size * 0.25),
    ...
    # Outer camera ring (silver/dark blue)
